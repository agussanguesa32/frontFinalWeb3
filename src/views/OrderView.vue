    ...
    <div class="m-3">
      <div class="d-flex justify-content-between align-items-start mt-4">
        ...
        <div class="d-flex flex-column flex-shrink-0 ml-3 mt-5 button-container">
          <button class="btn custom-button mb-2" @click="openModal('pesarCamionModal')">
            Pesar Camion
          </button>
          <button class="btn custom-button mb-2" @click="openModal('finalizarCargaModal')">
            Finalizar Carga
          </button>
          <button class="btn custom-button mb-2" @click="openModal('pesajeFinalModal')">
            Pesaje Final
          </button>
          <button class="btn custom-button" @click="openModal('verConciliacionModal')">
            Ver Conciliación
          </button>
        </div>
      </div>
    </div>
    <button class="btn custom-button fixed-bottom-center" @click="openModal('nuevaOrdenModal', false)">Nueva Orden</button>

    <!-- Modal para pesar el camión -->
    <div v-if="selectedOrder" class="modal" id="pesarCamionModal" tabindex="-1" aria-labelledby="pesarCamionModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Pesar Camión</h5>
            <button type="button" class="btn-close" @click="closeModal('pesarCamionModal')"></button>
          </div>
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="pesoInput" v-model="pesoTexto" placeholder="Ingrese el peso...">
            </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" @click="listoClick">Listo</button>
            <button type="button" class="btn btn-secondary" @click="closeModal('pesarCamionModal')">Cerrar</button>
          </div>
        </div>
      </div>
    </div>
...
<div v-if="selectedOrder" class="modal" id="finalizarCargaModal" tabindex="-1" aria-labelledby="finalizarCargaModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <!-- Cabecera del modal -->
      <div class="modal-header">
        <h5 class="modal-title" id="finalizarCargaModalLabel">Finalizar Carga</h5>
        <button type="button" class="btn-close" @click="closeModal('pesarCamionModal')"></button>
      </div>
      ...
      <div class="modal-footer justify-content-center">
        <button type="button" class="btn btn-primary" @click="listoClick">Aceptar</button>
        <button type="button" class="btn btn-secondary" @click="closeModal('finalizarCargaModal')">Cancelar</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div v-if="selectedOrder" class="modal" id="pesajeFinalModal" tabindex="-1" aria-labelledby="pesajeFinalModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Pesaje Final</h5>
            <button type="button" class="btn-close" @click="closeModal('pesajeFinalModal')"></button>
          </div>
          <div class="modal-body">
            <h6>Orden: {{ selectedOrder.orden }}</h6>
            <h6>Camión: {{ selectedOrder.camion }}</h6>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" @click="listoClick">Listo</button>
            <button type="button" class="btn btn-secondary" @click="closeModal('pesajeFinalModal')">Cerrar</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div v-if="selectedOrder" class="modal" id="verConciliacionModal" tabindex="-1" aria-labelledby="verConciliacionModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
...
<div class="modal" id="nuevaOrdenModal" tabindex="-1" aria-labelledby="nuevaOrdenModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="nuevaOrdenModalLabel">Nueva Orden</h5>
        <button type="button" class="btn-close" @click="closeModal('nuevaOrdenModal')"></button>
      </div>
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <datepicker v-model="fechaSeleccionada" :language="es"></datepicker>
          </div>
        </div>

      <div class="modal-footer justify-content-center">
        <button type="button" class="btn btn-primary" @click="listoClick">Aceptar</button>
        <button type="button" class="btn btn-secondary" @click="closeModal('nuevaOrdenModal')">Cancelar</button>
      </div>
    </div>
  </div>
</div>
  ...
  methods: {
    openModal(modalId, validateSelection = true) {
      if (validateSelection) {
        const selectedOrders = this.sortedOrders.filter(order => order.selected);
